<template><div><TagLinks /><!-- http://localhost:8080/blog/2024-04-30_DeckbuildingTheory.html -->
<h1 id="my-fftcg-deckbuilding-theory" tabindex="-1"><a class="header-anchor" href="#my-fftcg-deckbuilding-theory" aria-hidden="true">#</a> My FFTCG Deckbuilding Theory</h1>
<p>By: Kevin Fung</p>
<h2 id="general-thoughts" tabindex="-1"><a class="header-anchor" href="#general-thoughts" aria-hidden="true">#</a> General Thoughts</h2>
...
<br>
<p>In my opinion a good deck is an unfair deck.</p>
<h3 id="tier-0" tabindex="-1"><a class="header-anchor" href="#tier-0" aria-hidden="true">#</a> &quot;Tier 0&quot;</h3>
<p>In general, the goal is to create a &quot;Tier 0&quot; deck that &quot;solves&quot; the meta. This is done by identifying cards with insane abilities or incredible value. Usually there are certain prerequisites in order to unleash the full potential of these cards and require you to construct the deck around them. For Example, Macherie and Doga needed you to run a lot of summons particularly Earth/Water ones for the latter. Sterne Leonis required you to build a deck with a lot of forwards with ideally 3cp costs in order to maximize his abilities.</p>
<h3 id="doga-and-sterne-leonis" tabindex="-1"><a class="header-anchor" href="#doga-and-sterne-leonis" aria-hidden="true">#</a> Doga and Sterne Leonis</h3>
<p>In Opus 14 and 15, Doga decks were the clear Tier 0 best decks with many of the core cards eventually becoming banned or limited: Doga, Sophie, Macherie, Syldra. These decks were so strong and prevalent that may of the card prices soared to over $50 and become unobtainable for many players.</p>
<p>Sterne Leonis decks were able to eventually break through with chocobos utilizing the unfair abiliies of fat chocobo</p>
<h2 id="where-do-i-start" tabindex="-1"><a class="header-anchor" href="#where-do-i-start" aria-hidden="true">#</a> Where do I Start?</h2>
...
<h3 id="packages" tabindex="-1"><a class="header-anchor" href="#packages" aria-hidden="true">#</a> Packages</h3>
...
<p>As the much esteemed Kyle Peters and Ryan Chen put it, you can bring  <a href="https://youtu.be/CSuUGmeLL84?si=UidUzDjYY85fF2Ce&t=2472">50 good cards  </a> at all times.</p>
</div></template>
